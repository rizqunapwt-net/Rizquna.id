<?php
	...
	$vw_book_store_slider_height = get_theme_mod('vw_book_store_slider_height','550px');
	...
	$vw_book_store_related_image_box_shadow = get_theme_mod('vw_book_store_related_image_box_shadow',0);
	if($vw_book_store_related_image_box_shadow != false){
		$vw_book_store_custom_css .='.related-post .box-image img{';
			$vw_book_store_custom_css .='box-shadow: '.esc_attr($vw_book_store_related_image_box_shadow).'px '.esc_attr($vw_book_store_related_image_box_shadow).'px '.esc_attr($vw_book_store_related_image_box_shadow).'px #cccccc;';
		$vw_book_store_custom_css .='}';
	}

	/*------------------Responsive Media -----------------------*/

	$vw_book_store_resp_topbar = get_theme_mod( 'vw_book_store_resp_topbar_hide_show',true);
	if($vw_book_store_resp_topbar == true && get_theme_mod( 'vw_book_store_topbar_hide_show', true) == false){
	...
	if($vw_book_store_resp_slider == true && get_theme_mod( 'vw_book_store_slider_hide_show', true) == false){
    	$vw_book_store_custom_css .='#slider{';
			$vw_book_store_custom_css .='display:none;';
		$vw_book_store_custom_css .='} ';
	}
	...
	if($vw_book_store_resp_menu_toggle_btn_bg_color != false){
		$vw_book_store_custom_css .='.toggle-nav i,.sidenav .closebtn{';
	...
	$vw_book_store_button_letter_spacing = get_theme_mod('vw_book_store_button_letter_spacing');
	$vw_book_store_custom_css .='.post-main-box .blogbutton-small{';
	...
	$vw_book_store_featured_image_box_shadow = get_theme_mod('vw_book_store_featured_image_box_shadow',0);
	if($vw_book_store_featured_image_box_shadow != false){
		$vw_book_store_custom_css .='.box-image img,  #content-vw img{';
			$vw_book_store_custom_css .='box-shadow: '.esc_attr($vw_book_store_featured_image_box_shadow).'px '.esc_attr($vw_book_store_featured_image_box_shadow).'px '.esc_attr($vw_book_store_featured_image_box_shadow).'px #cccccc;';
		$vw_book_store_custom_css .='}';
	}
	...
	$vw_book_store_singlepost_image_box_shadow = get_theme_mod('vw_book_store_singlepost_image_box_shadow',0);
	if($vw_book_store_singlepost_image_box_shadow != false){
		$vw_book_store_custom_css .='.feature-box img{';
			$vw_book_store_custom_css .='box-shadow: '.esc_attr($vw_book_store_singlepost_image_box_shadow).'px '.esc_attr($vw_book_store_singlepost_image_box_shadow).'px '.esc_attr($vw_book_store_singlepost_image_box_shadow).'px #cccccc;';
		$vw_book_store_custom_css .='}';
	}
	...
	$vw_book_store_resp_stickycopyright = get_theme_mod( 'vw_book_store_stickycopyright_hide_show',false);
	if($vw_book_store_resp_stickycopyright == true && get_theme_mod( 'vw_book_store_copyright_sticky',false) != true){
    	$vw_book_store_custom_css .='.copyright-sticky{';
			$vw_book_store_custom_css .='position:static;';
		$vw_book_store_custom_css .='} ';
	}

	$vw_book_store_footer_social_icons_font_size = get_theme_mod('vw_book_store_footer_social_icons_font_size','16');
	$vw_book_store_custom_css .='.copyright .widget i{';
		$vw_book_store_custom_css .='font-size: '.esc_attr($vw_book_store_footer_social_icons_font_size).'px;';
	$vw_book_store_custom_css .='}';
	...
	$vw_book_store_align_footer_social_icon = get_theme_mod('vw_book_store_align_footer_social_icon');
	if($vw_book_store_align_footer_social_icon != false){
		$vw_book_store_custom_css .='.copyright .widget{';
			$vw_book_store_custom_css .='text-align: '.esc_attr($vw_book_store_align_footer_social_icon).';';
		$vw_book_store_custom_css .='}';
		$vw_book_store_custom_css .='
		@media screen and (max-width:720px) {
			.copyright .widget{';
	...
	$vw_book_store_breadcrumbs_alignment = get_theme_mod( 'vw_book_store_breadcrumbs_alignment','Left');
    if($vw_book_store_breadcrumbs_alignment == 'Left'){
    	$vw_book_store_custom_css .='@media screen and (min-width:768px) {';
		$vw_book_store_custom_css .='.breadcrumbs{';
			$vw_book_store_custom_css .='text-align:start;';
		$vw_book_store_custom_css .='}}';
	}else if($vw_book_store_breadcrumbs_alignment == 'Center'){
		$vw_book_store_custom_css .='@media screen and (min-width:768px) {';
		$vw_book_store_custom_css .='.breadcrumbs{';
			$vw_book_store_custom_css .='text-align:center;';
		$vw_book_store_custom_css .='}}';
	}else if($vw_book_store_breadcrumbs_alignment == 'Right'){
		$vw_book_store_custom_css .='@media screen and (min-width:768px) {';
		$vw_book_store_custom_css .='.breadcrumbs{';
			$vw_book_store_custom_css .='text-align:end;';
		$vw_book_store_custom_css .='}}';
	}

	// sticky sidebar
		$vw_book_store_resp_stickysidebar = get_theme_mod( 'vw_book_store_stickysidebar_hide_show',false);
	if($vw_book_store_resp_stickysidebar == true && get_theme_mod( 'vw_book_store_sticky_sidebar',false) != true){
		$vw_book_store_custom_css .= '@media (min-width: 768px) {';
    	$vw_book_store_custom_css .='#sidebar{';
			$vw_book_store_custom_css .='position:static;';
		$vw_book_store_custom_css .='} ';
		$vw_book_store_custom_css .= '}';
	...
	$vw_book_store_show_first_caps = get_theme_mod('vw_book_store_show_first_caps', false);
	if ($vw_book_store_show_first_caps ) {
	    $vw_book_store_custom_css .= '.post-main-box .new-text p:nth-of-type(1)::first-letter {';
	    $vw_book_store_custom_css .=' font-size: 55px;font-weight: 600;margin-right: 5px;';
	    $vw_book_store_custom_css .='}';
	} else {
		$vw_book_store_custom_css .= '.post-main-box .new-text p:nth-of-type(1)::first-letter {';
	    $vw_book_store_custom_css .= 'display: none;';
	...
	$vw_book_store_show_featured = get_theme_mod( 'vw_book_store_featured_image_hide_show', 1 );
	$vw_book_store_hover_effect  = get_theme_mod( 'vw_book_store_featured_image_hover', 'none' );

	if ( $vw_book_store_show_featured && $vw_book_store_hover_effect !== 'none' ) {

		$vw_book_store_custom_css .= '
		.vw-book-store-featured-image img{
			transition: all 0.4s ease;
		}';

		if ( $vw_book_store_hover_effect === 'zoom-in' ) {
			$vw_book_store_custom_css .= '
			.vw-book-store-featured-image:hover img{
				transform: scale(1.2);
			}';
		}

		if ( $vw_book_store_hover_effect === 'zoom-out' ) {
			$vw_book_store_custom_css .= '
			.vw-book-store-featured-image img{
				transform: scale(1.2);
			}
		...
		if ( $vw_book_store_hover_effect === 'grayscale' ) {
			$vw_book_store_custom_css .= '
			.vw-book-store-featured-image img{
		...
		if ( $vw_book_store_hover_effect === 'sepia' ) {
			$vw_book_store_custom_css .= '
			.vw-book-store-featured-image:hover img{
				filter: sepia(100%);
			}';
		...
		if ( $vw_book_store_hover_effect === 'blur' ) {
			$vw_book_store_custom_css .= '
			.vw-book-store-featured-image:hover img{
				filter: blur(3px);
			}';
		...
		if ( $vw_book_store_hover_effect === 'bright' ) {
			$vw_book_store_custom_css .= '
			.vw-book-store-featured-image:hover img{
		...
		if ( $vw_book_store_hover_effect === 'translate' ) {
			$vw_book_store_custom_css .= '
			.vw-book-store-featured-image:hover img{
