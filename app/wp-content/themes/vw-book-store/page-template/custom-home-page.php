...
<main id="maincontent" role="main">
  ...
  <?php if( get_theme_mod( 'vw_book_store_slider_hide_show', true) == 1 || get_theme_mod( 'vw_book_store_resp_slider_hide_show', true) == 1) { ?>
    <section id="slider">
