...
function vw_book_store_activation_notice() {
	...
	$vw_book_store_meta = get_option( 'vw_book_store_admin_notice' );

	if (!$vw_book_store_meta) {
		echo '<div id="vw-book-store-welcome-notice" class="notice notice-success is-dismissible welcome-notice">';
		echo '<div class="notice-row">';
			echo '<div class="notice-text">';
				echo '<p class="welcome-text1">'. esc_html__( '🎉 Welcome to VW Themes,', 'vw-book-store' ) .'</p>';
				echo '<p class="welcome-text2">'. esc_html__( 'You are now using the VW Book Store, a beautifully designed theme to kickstart your website.', 'vw-book-store' ) .'</p>';
				echo '<p class="welcome-text3">'. esc_html__( 'To help you get started quickly, use the options below:', 'vw-book-store' ) .'</p>';
				echo '<span class="import-btn"><a href="'. esc_url( admin_url( 'admin.php?page=vw_book_store_guide' ) ) .'" class="button button-primary">'. esc_html__( 'IMPORT DEMO', 'vw-book-store' ) .'</a></span>';
				...
				echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.vwthemes.com/products/bookstore-wordpress-theme' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE TO PRO', 'vw-book-store' ) .'</a></span>';
				echo '<span class="bundle-btn"><a href="'. esc_url( 'https://www.vwthemes.com/products/wp-theme-bundle' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'BUNDLE OF 400+ THEMES', 'vw-book-store' ) .'</a></span>';
			echo '</div>';
			echo '<div class="notice-img1">';
				echo '<img src="' . esc_url( get_template_directory_uri() . '/inc/getstart/images/arrow-notice.png' ) . '" width="180" alt="' . esc_attr__( 'VW Book Store', 'vw-book-store' ) . '" />';
			echo '</div>';
			echo '<div class="notice-img2">';
				echo '<img src="' . esc_url( get_template_directory_uri() . '/inc/getstart/images/bundle-notice.png' ) . '" width="180" alt="' . esc_attr__( 'VW Book Store', 'vw-book-store' ) . '" />';
			echo '</div>';	
		echo '</div>';	
	echo '</div>';
}
...
function vw_book_store_font_url() {
	...
	return $font_url;
	$contents = vw_book_store_wptt_get_webfont_url( esc_url_raw( $fonts_url ) );
}
...
function vw_book_store_init_setup() {
...
add_action( 'after_setup_theme', 'vw_book_store_init_setup' );	

// Admin notice code START
function vw_book_store_dismissed_notice() {
	update_option( 'vw_book_store_admin_notice', true );
}
add_action( 'wp_ajax_vw_book_store_dismissed_notice', 'vw_book_store_dismissed_notice' );

//After Switch theme function
add_action('after_switch_theme', 'vw_book_store_getstart_setup_options');
function vw_book_store_getstart_setup_options () {
    update_option('vw_book_store_admin_notice', false );
}
