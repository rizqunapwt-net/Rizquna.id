...
= 1.5.6 =
  ...
  -- Resolved css error for copyright alignment.
  -- Resolved css error for social icons in mobile media.
  -- Resolved css error for view cart button.
  -- Resolved css error for checkout page in tablet media
  -- Tested upto WP v6.8
...
* pxhere Images,
  ...
  Slider Image
  License: CC0 1.0 Universal (CC0 1.0)
  Source: https://pxhere.com/en/photo/948619

  Slider Image
  License: CC0 1.0 Universal (CC0 1.0)
  Source: https://pxhere.com/en/photo/766921
