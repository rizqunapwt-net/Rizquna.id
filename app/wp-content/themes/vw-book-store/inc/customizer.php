...
function vw_book_store_customize_register( $wp_customize ) {
   ...
   $wp_customize->add_setting('vw_book_store_header_my_account_icon',array(
	...
	$wp_customize->add_control( 'vw_book_store_slider_opacity_color', array(
		...
		'choices' => array(
	      '0' =>  esc_attr( __('0','vw-book-store')),
	      '0.1' =>  esc_attr( __('0.1','vw-book-store')),
	      '0.2' =>  esc_attr( __('0.2','vw-book-store')),
	      '0.3' =>  esc_attr( __('0.3','vw-book-store')),
	      '0.4' =>  esc_attr( __('0.4','vw-book-store')),
	      '0.5' =>  esc_attr( __('0.5','vw-book-store')),
	      '0.6' =>  esc_attr( __('0.6','vw-book-store')),
	      '0.7' =>  esc_attr( __('0.7','vw-book-store')),
	      '0.8' =>  esc_attr( __('0.8','vw-book-store')),
	      '0.9' =>  esc_attr( __('0.9','vw-book-store'))
		),
		'active_callback' => 'vw_book_store_default_slider'
	));
	...
	$wp_customize->add_control('vw_book_store_site_services_btn',array(
		'description' => "<a class='go-pro' target='_blank' href=".esc_url(VW_BOOK_STORE_GO_PRO_URL).">More Info</a>", 
		'section'=> 'vw_book_store_site_services',
		'type'=> 'hidden'
	));
	...
	$default_product_page_id = get_theme_mod('vw_book_shop_product_page', '');

	for ( $count = 0; $count <= 0; $count++ ) {
		$wp_customize->add_setting( 'vw_book_shop_product_page', array(
			'default'           =>  $default_product_page_id, 
			'sanitize_callback' => 'vw_book_store_sanitize_dropdown_pages'
		));

		$wp_customize->add_control( 'vw_book_shop_product_page' , array(
			'label'    => __( 'Select Page', 'vw-book-store' ),
			'section'  => 'vw_book_store_book_store',
			'type'     => 'dropdown-pages',
			'choices'  => array($default_product_page_id => get_the_title($default_product_page_id)), // Ensure default selection
		));
	}
    ...
    $wp_customize->add_setting('vw_book_store_align_footer_social_icon',array(
        'default' => 'center',
        'sanitize_callback' => 'vw_book_store_sanitize_choices'
	));
	$wp_customize->add_control('vw_book_store_align_footer_social_icon',array(
        'type' => 'select',
        'label' => __('Social Icon Alignment ','vw-book-store'),
        'section' => 'vw_book_store_footer',
        'choices' => array(
            'left' => __('Left','vw-book-store'),
            'right' => __('Right','vw-book-store'),
            'center' => __('Center','vw-book-store'),
        ),
	) );

	$wp_customize->add_setting( 'vw_book_store_copyright_sticky',array(
      'default' => 0,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_book_store_switch_sanitization'
    ) );
    $wp_customize->add_control( new VW_Book_Store_Toggle_Switch_Custom_Control( $wp_customize, 'vw_book_store_copyright_sticky',array(
      'label' => esc_html__( 'Show / Hide Sticky Copyright','vw-book-store' ),
      'section' => 'vw_book_store_footer'
    )));

   $wp_customize->add_setting('vw_book_store_footer_social_icons_font_size',array(
       'default'=> 16,
       'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('vw_book_store_footer_social_icons_font_size',array(
    'label' => __('Social Icon Font Size','vw-book-store'),
    	'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
			'min'              => 1,
   ...
   $wp_customize->add_setting( 'vw_book_store_excerpt_number', array(
	...
	$wp_customize->add_setting('vw_book_store_show_first_caps', array(
	    'default'           => false,
	    'transport'         => 'refresh',
	    'sanitize_callback' => 'vw_book_store_switch_sanitization',
	));

	$wp_customize->add_control(new Vw_book_store_Toggle_Switch_Custom_Control(
	    $wp_customize,
	    'vw_book_store_show_first_caps',
	    array(
	        'label'   => esc_html__('First Cap (First Capital Letter)', 'vw-book-store'),
	        'section' => 'vw_book_store_post_settings',
	    )
	));
	...
	$wp_customize->add_setting( 'vw_book_store_related_toggle_postdate',array(
	    'default' => 1,
	    'transport' => 'refresh',
	    'sanitize_callback' => 'vw_book_store_switch_sanitization'
  	));
  	$wp_customize->add_control( new VW_Book_Store_Toggle_Switch_Custom_Control( $wp_customize, 'vw_book_store_related_toggle_postdate',array(
	    'label' => esc_html__( 'Show / Hide Post Date','vw-book-store' ),
	    'section' => 'vw_book_store_related_posts_settings'
  	)));

  	$wp_customize->add_setting('vw_book_store_related_postdate_icon',array(
	    'default' => 'fas fa-calendar-alt',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new VW_Book_Store_Fontawesome_Icon_Chooser(
  	$wp_customize,'vw_book_store_related_postdate_icon',array(
	    'label' => __('Add Post Date Icon','vw-book-store'),
	    'transport' => 'refresh',
	    'section' => 'vw_book_store_related_posts_settings',
	    'setting' => 'vw_book_store_related_postdate_icon',
	    'type'    => 'icon'
  	)));

	$wp_customize->add_setting( 'vw_book_store_related_toggle_author',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_book_store_switch_sanitization'
  	));
  	$wp_customize->add_control( new VW_Book_Store_Toggle_Switch_Custom_Control( $wp_customize, 'vw_book_store_related_toggle_author',array(
		'label' => esc_html__( 'Show / Hide Author','vw-book-store' ),
		'section' => 'vw_book_store_related_posts_settings'
  	)));

  	$wp_customize->add_setting('vw_book_store_related_author_icon',array(
	    'default' => 'fas fa-user',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new VW_Book_Store_Fontawesome_Icon_Chooser(
  	$wp_customize,'vw_book_store_related_author_icon',array(
	    'label' => __('Add Author Icon','vw-book-store'),
	    'transport' => 'refresh',
	    'section' => 'vw_book_store_related_posts_settings',
	    'setting' => 'vw_book_store_related_author_icon',
	    'type'    => 'icon'
  	)));

	$wp_customize->add_setting( 'vw_book_store_related_toggle_comments',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_book_store_switch_sanitization'
  	) );
  	$wp_customize->add_control( new VW_Book_Store_Toggle_Switch_Custom_Control( $wp_customize, 'vw_book_store_related_toggle_comments',array(
		'label' => esc_html__( 'Show / Hide Comments','vw-book-store' ),
		'section' => 'vw_book_store_related_posts_settings'
  	)));

  	$wp_customize->add_setting('vw_book_store_related_comments_icon',array(
	    'default' => 'fa fa-comments',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new VW_Book_Store_Fontawesome_Icon_Chooser(
  	$wp_customize,'vw_book_store_related_comments_icon',array(
	    'label' => __('Add Comments Icon','vw-book-store'),
	    'transport' => 'refresh',
	    'section' => 'vw_book_store_related_posts_settings',
	    'setting' => 'vw_book_store_related_comments_icon',
	    'type'    => 'icon'
  	)));

	$wp_customize->add_setting( 'vw_book_store_related_toggle_time',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_book_store_switch_sanitization'
  	) );
  	$wp_customize->add_control( new VW_Book_Store_Toggle_Switch_Custom_Control( $wp_customize, 'vw_book_store_related_toggle_time',array(
		'label' => esc_html__( 'Show / Hide Time','vw-book-store' ),
		'section' => 'vw_book_store_related_posts_settings'
  	)));

  	$wp_customize->add_setting('vw_book_store_related_time_icon',array(
	    'default' => 'fas fa-clock',
	    'sanitize_callback' => 'sanitize_text_field'
  	));
  	$wp_customize->add_control(new VW_Book_Store_Fontawesome_Icon_Chooser(
  	$wp_customize,'vw_book_store_related_time_icon',array(
	    'label' => __('Add Time Icon','vw-book-store'),
	    'transport' => 'refresh',
	    'section' => 'vw_book_store_related_posts_settings',
	    'setting' => 'vw_book_store_related_time_icon',
	    'type'    => 'icon'
  	)));


  	$wp_customize->add_setting('vw_book_store_related_post_meta_field_separator',array(
		'default'=> '|',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_book_store_related_post_meta_field_separator',array(
		'label'	=> __('Add Meta Separator','vw-book-store'),
		'description' => __('Add the seperator for meta box. Example: "|", "/", etc.','vw-book-store'),
		'section'=> 'vw_book_store_related_posts_settings',
		'type'=> 'text'
	...
	$wp_customize->add_setting( 'vw_book_store_related_image_hide_show',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_book_store_switch_sanitization'
	));
  	$wp_customize->add_control( new VW_Book_Store_Toggle_Switch_Custom_Control( $wp_customize, 'vw_book_store_related_image_hide_show', array(
		'label' => esc_html__( 'Show / Hide Featured Image','vw-book-store' ),
		'section' => 'vw_book_store_related_posts_settings'
  	)));

  	$wp_customize->add_setting( 'vw_book_store_related_image_box_shadow', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_book_store_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_book_store_related_image_box_shadow', array(
		'label'       => esc_html__( 'Related post Image Box Shadow','vw-book-store' ),
		'section'     => 'vw_book_store_related_posts_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
  	...
  	$wp_customize->add_setting('vw_book_store_related_button_text',array(
		'default'=> esc_html__('Read More','vw-book-store'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('vw_book_store_related_button_text',array(
	...
	$wp_customize->add_setting( 'vw_book_store_singlepost_image_box_shadow', array(
		'default'              => '0',
		'transport' 		   => 'refresh',
		'sanitize_callback'    => 'vw_book_store_sanitize_number_range'
	) );
	$wp_customize->add_control( 'vw_book_store_singlepost_image_box_shadow', array(
		'label'       => esc_html__( 'Single post Image Box Shadow','vw-book-store' ),
		'section'     => 'vw_book_store_single_blog_settings',
		'type'        => 'range',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting(
		'vw_book_store_featured_image_hover',
		array(
			'default'           => 'none',
			'sanitize_callback' => 'sanitize_text_field',
		)
	...
	$wp_customize->add_control(
		'vw_book_store_featured_image_hover',
		array(
			'label'   => __( 'Featured Image Hover Effect', 'vw-book-store' ),
			'section' => 'vw_book_store_single_blog_settings',
			'type'    => 'select',
			'choices' => array(
				'none'      => __( 'None', 'vw-book-store' ),
				'zoom-in'   => __( 'Zoom In', 'vw-book-store' ),
				'zoom-out'  => __( 'Zoom Out', 'vw-book-store' ),
				'scale'     => __( 'Scale', 'vw-book-store' ),
				'grayscale' => __( 'Grayscale', 'vw-book-store' ),
				'blur'      => __( 'Blur', 'vw-book-store' ),
				'bright'    => __( 'Bright', 'vw-book-store' ),
				'sepia'     => __( 'Sepia', 'vw-book-store' ),
				'translate' => __( 'Translate', 'vw-book-store' ),
			),
		)
	);
    ...
    $wp_customize->add_setting( 'vw_book_store_grid_image_hide_show',array(
		'default' => 1,
		'transport' => 'refresh',
		'sanitize_callback' => 'vw_book_store_switch_sanitization'
	));
  	$wp_customize->add_control( new VW_Book_Store_Toggle_Switch_Custom_Control( $wp_customize, 'vw_book_store_grid_image_hide_show', array(
		'label' => esc_html__( 'Show / Hide Featured Image','vw-book-store' ),
		'section' => 'vw_book_store_grid_layout_settings'
  	)));
	...
	// Progress Bar
	$wp_customize->add_setting( 'vw_book_store_progress_bar', array(
		'default'           => 0, 
		'transport'         => 'refresh',
		'sanitize_callback' => 'vw_book_store_switch_sanitization',
	));
	...
	$wp_customize->add_control(
		new VW_Book_Store_Toggle_Switch_Custom_Control(
			$wp_customize,
			'vw_book_store_progress_bar',
			array(
				'label'   => esc_html__( 'Show / Hide Progress Bar', 'vw-book-store' ),
				'section' => 'vw_book_store_left_right',
			)
		)
	);
	...
	$wp_customize->add_setting('vw_book_store_breadcrumbs_alignment',array(
        'default' => 'Left',
        'sanitize_callback' => 'vw_book_store_sanitize_choices'
	));
	$wp_customize->add_control('vw_book_store_breadcrumbs_alignment',array(
        'type' => 'select',
        'label' => __('Breadcrumbs Alignment','vw-book-store'),
        'section' => 'vw_book_store_left_right',
        'choices' => array(
            'Left' => __('Left','vw-book-store'),
            'Right' => __('Right','vw-book-store'),
	...
	$wp_customize->add_setting( 'vw_book_store_sticky_sidebar',array(
      'default' => 0,
      'transport' => 'refresh',
      'sanitize_callback' => 'vw_book_store_switch_sanitization'
    ) );
    $wp_customize->add_control( new Vw_book_store_Toggle_Switch_Custom_Control( $wp_customize, 'vw_book_store_sticky_sidebar',array(
      'label' => esc_html__( 'Show / Hide Sticky Sidebar','vw-book-store' ),
      'section' => 'vw_book_store_left_right'
    )));
